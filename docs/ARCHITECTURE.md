...
SQLite ist für transaktionale Daten vorgesehen: Benutzer, persönliche Erinnerungen einschließlich Wiederholungsintervall und nächstem Reaktivierungszeitpunkt, Lagerorte, Artikel, Bestände, Bestandsbewegungen, Reservierungen, Argon2id-Hashes, Sitzungen, Anmeldebegrenzung, Projektfreigaben, Tags, Einstellungen und Auditereignisse. Erinnerungen gehören jeweils genau einem Benutzer und bleiben von Projektarbeitsschritten und Logbucheinträgen getrennt. Reservierungen verweisen über deren stabile IDs auf die dateibasierten Projekte und Projektelemente; diese Verweise werden im Domain-Layer aufgelöst und geprüft, da zwischen SQLite und Projektdateien kein Foreign Key möglich ist. Die verbindlichen Lagerregeln stehen in `docs/INVENTORY-DOMAIN.md`.

Der versionierte Beispieldatensatz liegt in `public/demo-data.json`. Seine Projekt-, Ordner-, Tag-, Lager- und Artikel-IDs verwenden den reservierten Präfix `demo-`. Installation und Entfernen laufen ausschließlich serverseitig über administrative API-Endpunkte. Neben Projekten enthält das Manifest Lagerorte, Artikel, Bestandseinträge, Anfangsbuchungen und Projektreservierungen. Beim Entfernen werden nur die im Manifest aufgeführten Projekte und Artikel samt ihrer abhängigen Demo-Bestandsdaten gelöscht. Demo-Ordner und Demo-Lagerorte werden nur entfernt, wenn keine eigenen Inhalte oder Unterorte mehr von ihnen abhängen. Gleichnamige, bereits vorhandene Nutzertags werden beim Einspielen wiederverwendet und beim Entfernen nicht gelöscht.
...
Projekt- und Benutzerbackups bleiben getrennt. Projektarchive enthalten Projekte, verwendete Tags, Projektordner und Servereinstellungen; Benutzerarchive enthalten Konten, persönliche Erinnerungen samt ihrer maximal einteiligen Unterordnung, Wiederholungsangaben und getrenntem Erledigt-/Aufräumstatus, Projektfreigaben, persönliche Einstellungen und Passwort-Hashes. Beim Abhaken bleiben Erinnerungen an ihrer Position. Erst „Aufräumen“ verschiebt erledigte Erinnerungen auf der Hauptebene ohne offene Kinder samt ihrer weiterhin zugeordneten untergeordneten Erinnerungen in den Erledigt-Bereich. Der Wiederholungszeitraum beginnt bereits beim Abhaken; wird sein Ende vor dem Aufräumen erreicht, öffnet sich die Erinnerung direkt wieder. Fällige Erinnerungen werden beim nächsten Listenabruf oder durch den Seitentimer geöffnet. Wiederkehrende Erinnerungen und Gruppen, die eine solche Erinnerung enthalten, sind vor dem gemeinsamen Löschen erledigter Erinnerungen geschützt. Sie lassen sich weiterhin einzeln löschen oder nach dem Entfernen der Wiederholung gemeinsam löschen. Klartextpasswörter und Sitzungen werden nicht exportiert. Benutzerarchive müssen deshalb wie Geheimnisse behandelt werden. Für eine vollständige Wiederherstellung wird zuerst das Benutzer- und danach das Projektarchiv eingespielt; ältere Archive bleiben importierbar, können aber nur Daten wiederherstellen, die sie bereits enthielten.
