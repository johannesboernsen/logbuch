...
SQLite ist für transaktionale Daten vorgesehen: Benutzer, persönliche Erinnerungen einschließlich Wiederholungsintervall und nächstem Reaktivierungszeitpunkt, Argon2id-Hashes, Sitzungen, Anmeldebegrenzung, Projektfreigaben, Tags, Einstellungen und Auditereignisse. Erinnerungen gehören jeweils genau einem Benutzer und bleiben von Projektarbeitsschritten und Logbucheinträgen getrennt.
